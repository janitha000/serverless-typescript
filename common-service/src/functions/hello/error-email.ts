...
let generateEmailContent = (data, message) => {
    ...
    let text = `Alarm Name:<b>${message.AlarmName
        }</b><br/>Details: <a href="https://my.example.com">Production URL</a><br/>Account ID:${message.AWSAccountId
    ...
    let emailContent = {
        ...
        // SourceArn: "arn:aws:ses:us-east-1:885121665536:identity/janitha000@gmail.com",
        Tags: [
            {
                Name: "sender",
                Value: "Manoj"
...
module.exports.dispatchErrors = (event: SNSEvent, context, _cb) => {
